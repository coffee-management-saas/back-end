...
public interface OrderRepository extends JpaRepository<Order, Long>, JpaSpecificationExecutor<Order> {
    ...
    Integer countAllByOrderStatusAndOrderTypeAndShopIdAndCreatedAtBetween(OrderStatus status, OrderType type, Long shopId, LocalDateTime fromDate, LocalDateTime toDate);
}
