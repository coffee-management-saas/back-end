...
VALUES
    ...
    (NOW(), NOW(), 'shopDashboard:shop', 'Dashboard của cửa hàng', 'ACTIVE'),
    (NOW(), NOW(), 'shopDashboard:shop-daily', 'Dashboard hằng ngày của cửa hàng', 'ACTIVE'),
    (NOW(), NOW(), 'shopDashboard:system', 'Dashboard hằng tháng của system', 'ACTIVE'),
